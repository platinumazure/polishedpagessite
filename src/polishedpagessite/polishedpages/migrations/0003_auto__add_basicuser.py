...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'polishedpages_basicuser', (
            ...
            ('author_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polishedpages.AuthorProfile'])),
        ))
        db.send_create_signal('polishedpages', ['BasicUser'])


    def backwards(self, orm):
        # Deleting model 'BasicUser'
        db.delete_table(u'polishedpages_basicuser')
    ...
    models = {
        ...
        'polishedpages.basicuser': {
            ...
            'author_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['polishedpages.AuthorProfile']"}),
